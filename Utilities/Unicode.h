...
/* Don't use Unicode string constants (concatenation of string constants using the UNICODE_..._UTF8
   defines) when compiling with Xcode 3.1 beta (iPhone SDK beta): with this version all Unicode strings
   in a compilation unit are replaced with the first one. Reported to Apple with bug ID 5788599. */
...
#define UNICODE_MIDDLE_DOT_UTF8			"\xc2\xb7"	// ·
