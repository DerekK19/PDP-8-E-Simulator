...
#define ALLOWS_EDITING	YES
#define MENU_TITLE	@"FPP8-A EP Floating Point (6 words)"
#define TOOL_TIP	@"This column displays the memory content as FPP8-A EP floating point numbers."
...
- (BOOL) allowsEditing
{
	return ALLOWS_EDITING;
}


- (NSString *) toolTipForContentColumn
{
	return NSLocalizedString(TOOL_TIP, @"");
}
...
- (BOOL) getObjectValue:(id *)value forString:(NSString *)string errorDescription:(NSString **)error
{
	...
	*value = [NSArray arrayWithObjects:
		...
		[NSNumber numberWithInt:
			077770000 | ([f negative] ? 04000 : 0) | (unsigned) (mantissa >> 53)],
		[NSNumber numberWithInt:077770000 | (unsigned) ((mantissa >> 41) & 07777)],
		[NSNumber numberWithInt:077770000 | (unsigned) ((mantissa >> 29) & 07777)],
		[NSNumber numberWithInt:077770000 | (unsigned) ((mantissa >> 17) & 07777)],
		[NSNumber numberWithInt:077770000 | (unsigned) ((mantissa >> 5) & 07777)],
		nil];
	return TRUE;
}
