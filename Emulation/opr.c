...
VOID i7002 (VOID)			/* BSW				*/
{
    AC = (ushort) ((AC & 010000) | ((AC & 077) << 6) | ((AC & 07700) >> 6));
    EXECUTION_TIME (12);
}
/* -------------------------------------------------------------------- */
...
{
    AC = (ushort) (((AC ^ 010000) & 010000) + ((AC & 077) << 6) + ((AC & 07700) >> 6));
    EXECUTION_TIME (12);
}
/* -------------------------------------------------------------------- */
...
{
    AC = (ushort) (010000 + ((AC & 07700) >> 6) + ((AC & 077) << 6));
    EXECUTION_TIME (12);
}
/* -------------------------------------------------------------------- */
...
{
    AC = (AC | 010000) + 1 ;
    AC = (ushort) ((AC & 010000) + ((AC & 07700) >> 6) + ((AC & 077) << 6));
    EXECUTION_TIME (12);
}
/* -------------------------------------------------------------------- */
